...
const EvolutionChart = () => {
  const data = [5.75, 5.78, 5.8, 5.82, 5.79, 5.76, 5.74, 5.75, 5.8, 5.85, 5.88, 5.9, 5.87, 5.85, 5.82, 5.8, 5.78, 5.75, 5.72, 5.7, 5.68, 5.7, 5.72, 5.75, 5.78, 5.8, 5.82, 5.85, 5.88, 5.9];
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-[#1a1a1a]/50 backdrop-blur-xl border border-white/5 rounded-3xl p-6 md:p-8 h-full", children: [
    /* @__PURE__ */ jsxs("h3", { className: "text-xl font-semibold text-white mb-6 flex items-center gap-2", children: [
      /* @__PURE__ */ jsx(TrendingUp, { className: "w-5 h-5 text-emerald-500" }),
      "Evolução 30 Dias (Dólar)"
    ] }),
    /* @__PURE__ */ jsx("div", { className: "h-64 w-full flex items-end gap-1", children: data.map((value, i) => /* @__PURE__ */ jsxs("div", { className: "flex-1 bg-emerald-500/20 hover:bg-emerald-500/40 transition-colors rounded-t-sm relative group", children: [
      /* @__PURE__ */ jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsxs("div", { className: "opacity-0 group-hover:opacity-100 absolute bottom-full left-1/2 -translate-x-1/2 mb-2 bg-black/90 text-white text-xs p-2 rounded whitespace-nowrap pointer-events-none z-10 border border-white/10", children: [
        "R$ ",
        value.toFixed(2)
      ] })
    ] }, i)) }),
    /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-xs text-gray-500 mt-2", children: [
      /* @__PURE__ */ jsx("span", { children: "30 dias atrás" }),
      /* @__PURE__ */ jsx("span", { children: "Hoje" })
    ] })
  ] });
};
  ...
  return /* @__PURE__ */ jsxs("section", { className: "relative min-h-screen pt-32 pb-24 px-4 overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto relative z-10", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-12 gap-8 mb-16", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "mt-8 max-w-3xl mx-auto text-lg text-gray-400 space-y-4", children: /* @__PURE__ */ jsxs("p", { children: [
...
//# sourceMappingURL=CurrencyConverterPage-DeLIUDBA.js.map
