...
function MEIDasPage() {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "relative min-h-screen pt-32 pb-24 px-4 overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto relative z-10", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "mt-8 max-w-2xl mx-auto text-lg text-gray-400 text-center mb-12", children: /* @__PURE__ */ jsx("p", { children: "Mantenha sua empresa em dia. Saiba o valor da contribuição mensal do Microempreendedor Individual." }) }),
      /* @__PURE__ */ jsx(
        FAQ,
        {
          items: MEI_FAQS,
...
//# sourceMappingURL=MEIDasPage-DmL_M1PU.js.map
