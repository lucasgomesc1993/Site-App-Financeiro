...
import { Wallet, Calculator, Check, Zap, Coins, Briefcase, TrendingDown, AlertTriangle, DollarSign, HelpCircle } from "lucide-react";
      ...
      /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "text-center mb-12 animate-in fade-in slide-in-from-bottom-4 duration-700", children: [
          ...
          /* @__PURE__ */ jsxs("h1", { className: "text-4xl md:text-5xl font-bold text-white mb-6 tracking-tight", children: [
            ...
            /* @__PURE__ */ jsx("br", {}),
            /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-blue-500", children: "Cálculo Exato e Atualizado" })
          ] })
        ] })
      ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "pt-6 border-t border-white/5", children: [
              /* @__PURE__ */ jsx("div", { className: "bg-emerald-500/10 p-6 rounded-2xl border border-emerald-500/20 text-center mb-6 relative overflow-hidden", children: /* @__PURE__ */ jsxs("div", { className: "relative z-10", children: [
                /* @__PURE__ */ jsx("span", { className: "text-sm text-emerald-400 block mb-2 font-medium", children: "Salário Líquido Estimado" }),
                /* @__PURE__ */ jsx("span", { className: "block text-4xl md:text-5xl font-bold text-white tracking-tight", children: result ? `R$ ${result.netSalary.toLocaleString("pt-BR", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}` : "R$ 0,00" }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
                /* @__PURE__ */ jsxs("div", { className: "bg-white/5 p-4 rounded-xl border border-white/5 text-center transition-colors hover:bg-white/10", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-xs text-gray-400 block mb-1 flex items-center justify-center gap-1", children: "INSS" }),
                  /* @__PURE__ */ jsx("span", { className: "text-lg font-bold text-red-400", children: result ? `- R$ ${result.inss.toLocaleString("pt-BR", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}` : "---" })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "bg-white/5 p-4 rounded-xl border border-white/5 text-center transition-colors hover:bg-white/10", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-xs text-gray-400 block mb-1 flex items-center justify-center gap-1", children: "IRRF" }),
                  /* @__PURE__ */ jsx("span", { className: "text-lg font-bold text-red-400", children: result ? `- R$ ${result.irrf.toLocaleString("pt-BR", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}` : "---" }),
                  (result == null ? void 0 : result.usedSimplified) && /* @__PURE__ */ jsx("span", { className: "block text-[10px] text-emerald-400 mt-1", children: "(Simplificado)" })
                ] })
              ] })
            ] })
          ] })
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-b border-white/5 pb-2", children: [
                ...
                /* @__PURE__ */ jsxs("span", { className: "text-sm font-bold text-white text-right", children: [
                  "R$ 8.157,41 ",
                  /* @__PURE__ */ jsx("br", {}),
                  /* @__PURE__ */ jsx("span", { className: "text-[10px] font-normal text-gray-500", children: "(Desconto máx. de aprox. R$ 951,63)" })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-b border-white/5 pb-2", children: [
                /* @__PURE__ */ jsx("span", { className: "text-sm text-gray-400", children: "Isenção de IRRF" }),
                /* @__PURE__ */ jsxs("span", { className: "text-sm font-bold text-emerald-400 text-right", children: [
                  "Até R$ 2.428,80 ",
                  /* @__PURE__ */ jsx("br", {}),
                  /* @__PURE__ */ jsx("span", { className: "text-[10px] font-normal text-emerald-500/70", children: "(considerando regras vigentes)" })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-b border-white/5 pb-2", children: [
                ...
                /* @__PURE__ */ jsxs("span", { className: "text-sm font-bold text-white text-right", children: [
                  "R$ 607,20 ",
                  /* @__PURE__ */ jsx("br", {}),
                  /* @__PURE__ */ jsx("span", { className: "text-[10px] font-normal text-gray-500", children: "(dedução automática se vantajosa)" })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-b border-white/5 pb-2", children: [
                ...
                /* @__PURE__ */ jsxs("span", { className: "text-sm font-bold text-white text-right", children: [
                  "Lei 15.191 ",
                  /* @__PURE__ */ jsx("br", {}),
                  /* @__PURE__ */ jsx("span", { className: "text-[10px] font-normal text-gray-500", children: "e Portaria MPS/MF nº 6" })
                ] })
              ] })
            ] }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex gap-4 items-start", children: [
                ...
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("strong", { className: "text-white text-sm block", children: "INSS" }),
                  /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-400 mt-1", children: "Garante sua aposentadoria e auxílios. Desconto progressivo até o teto de R$ 951,63 (aprox)." })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex gap-4 items-start", children: [
                /* @__PURE__ */ jsx("div", { className: "w-1.5 h-1.5 rounded-full bg-red-400 mt-2 shrink-0" }),
                /* @__PURE__ */ jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-400 mt-1", children: 'Incide sobre o restante. O governo "ataca" seu salário progressivamente de 7.5% a 27.5%.' })
                ] })
              ] })
            ] })
          ] })
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-[#1a1a1a]/50 backdrop-blur-xl border border-white/5 rounded-3xl p-8 animate-in fade-in slide-in-from-bottom-4 duration-700", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
            ...
            /* @__PURE__ */ jsxs("p", { className: "text-sm text-gray-500 mt-2", children: [
              "Fonte: ",
              /* @__PURE__ */ jsx("a", { href: "https://www.gov.br/inss/pt-br/direitos-e-deveres/inscricao-e-contribuicao/tabela-de-contribuicao-mensal", target: "_blank", rel: "noopener noreferrer", className: "text-emerald-400 hover:underline", children: "Portaria Interministerial MPS/MF nº 6" })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsxs("h3", { className: "text-lg font-semibold text-white mb-4 flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxs("p", { className: "text-sm text-gray-500 mt-2", children: [
              ...
              /* @__PURE__ */ jsx("a", { href: "https://www.planalto.gov.br/ccivil_03/_ato2023-2026/2025/lei/L15191.htm", target: "_blank", rel: "noopener noreferrer", className: "text-emerald-400 hover:underline", children: "Lei nº 15.191/2025" })
            ] })
          ] })
        ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 gap-6 mb-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "bg-white/5 p-4 rounded-xl", children: [
              ...
              /* @__PURE__ */ jsxs("p", { className: "text-sm text-gray-400", children: [
                ...
                /* @__PURE__ */ jsx("a", { href: "http://normas.receita.fazenda.gov.br/sijut2consulta/consulta.action?termoBusca=Instru%E7%E3o+Normativa+RFB+n%BA+2.174", target: "_blank", rel: "noopener noreferrer", className: "text-emerald-400 hover:underline", children: "Instrução Normativa RFB nº 2.174" }),
                ")."
              ] })
            ] })
          ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 gap-6", children: [
            /* @__PURE__ */ jsxs("div", { className: "bg-white/5 p-6 rounded-2xl border border-white/5", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-3 text-sm text-gray-400", children: [
                ...
                /* @__PURE__ */ jsxs("p", { className: "text-xs text-gray-500 italic", children: [
...
//# sourceMappingURL=NetSalaryPage-xKGYH7o9.js.map
