...
const EvolutionChart = () => {
  const rawData = [5.75, 5.78, 5.8, 5.82, 5.79, 5.76, 5.74, 5.75, 5.8, 5.85, 5.88, 5.9, 5.87, 5.85, 5.82, 5.8, 5.78, 5.75, 5.72, 5.7, 5.68, 5.7, 5.72, 5.75, 5.78, 5.8, 5.82, 5.85, 5.88, 5.9];
  const chartData = rawData.map((value, index) => ({
    day: index,
    value,
    label: index === 0 ? "30 dias atrás" : index === 14 ? "15 dias" : index === 29 ? "Hoje" : ""
  }));
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-[#1a1a1a]/50 backdrop-blur-xl border border-white/5 rounded-3xl p-6 md:p-8 h-full flex flex-col", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "flex-1 w-full min-h-[200px]", children: /* @__PURE__ */ jsx(ChartContainer, { config: chartConfig, className: "h-full w-full aspect-auto", children: /* @__PURE__ */ jsxs(
      AreaChart,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(
            XAxis,
            {
              ...
              tickMargin: 8,
              tickFormatter: (value) => {
                if (value === 0) return "30 dias atrás";
                if (value === 14) return "15 dias";
                if (value === 29) return "Hoje";
                return "";
              },
              interval: 0
            }
...
//# sourceMappingURL=CurrencyConverterPage-ewYuHTb5.js.map
