...
import { Globe, Calculator, ChevronDown, RefreshCw, Wallet, CreditCard, Info, DollarSign, TrendingUp, AlertCircle } from "lucide-react";
...
function CurrencyConverterPage() {
  ...
  const [iofType, setIofType] = useState("money");
  ...
  const isBuyingForeign = fromCurrency !== "BRL" && toCurrency === "BRL";
  const iofPercentage = iofType === "card" ? 3.38 : 1.1;
  const iofMultiplier = 1 + iofPercentage / 100;
  const finalVetValue = isBuyingForeign && result ? result * iofMultiplier : result;
  const schema = {
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto relative z-10", children: [
      /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "text-center mb-12 animate-in fade-in slide-in-from-bottom-4 duration-700", children: [
          ...
          /* @__PURE__ */ jsxs("p", { className: "text-gray-400 mt-2 flex items-center justify-center gap-2", children: [
            /* @__PURE__ */ jsx("span", { className: `w-2 h-2 rounded-full ${loadingRates ? "bg-yellow-500 animate-pulse" : "bg-green-500"}` }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-12 gap-8 mb-16", children: [
        /* @__PURE__ */ jsx("div", { className: "lg:col-span-7 animate-in fade-in slide-in-from-left-4 duration-700 delay-200", children: /* @__PURE__ */ jsxs("div", { className: "bg-[#1a1a1a]/50 backdrop-blur-xl border border-white/5 rounded-3xl p-6 md:p-8 h-full", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-between gap-3 pt-2", children: [
              /* @__PURE__ */ jsx("span", { className: "text-xs text-gray-500 font-medium hidden sm:block", children: "IOF (Imposto):" }),
              /* @__PURE__ */ jsxs("div", { className: "flex w-full sm:w-auto bg-white/5 p-1 rounded-lg", children: [
                /* @__PURE__ */ jsxs(
                  "button",
                  {
                    onClick: () => setIofType("money"),
                    className: `flex-1 sm:flex-none justify-center px-4 py-1.5 text-xs font-medium rounded-md transition-all flex items-center gap-1.5 ${iofType === "money" ? "bg-emerald-500/20 text-emerald-400 shadow-sm" : "text-gray-400 hover:text-white hover:bg-white/5"}`,
                    children: [
                ...
                /* @__PURE__ */ jsxs(
                  "button",
                  {
                    ...
                    className: `flex-1 sm:flex-none justify-center px-4 py-1.5 text-xs font-medium rounded-md transition-all flex items-center gap-1.5 ${iofType === "card" ? "bg-emerald-500/20 text-emerald-400 shadow-sm" : "text-gray-400 hover:text-white hover:bg-white/5"}`,
                    children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "pt-2", children: /* @__PURE__ */ jsxs("div", { className: "bg-emerald-500/10 p-6 rounded-2xl border border-emerald-500/20 text-center mb-4", children: [
              /* @__PURE__ */ jsx("span", { className: "text-sm text-emerald-400 block mb-2", children: "Valor com IOF Estimado" }),
              /* @__PURE__ */ jsxs("span", { className: "text-4xl font-bold text-white", children: [
                finalVetValue ? `${toCurrency === "BRL" ? "R$" : ""} ${finalVetValue.toLocaleString("pt-BR", { minimumFractionDigits: 2 })}` : result ? `${toCurrency === "BRL" ? "R$" : toCurrency === "USD" ? "$" : toCurrency === "EUR" ? "€" : "£"} ${result.toLocaleString("pt-BR", { minimumFractionDigits: 2 })}` : "---",
                toCurrency !== "BRL" && result ? /* @__PURE__ */ jsx("span", { className: "text-lg ml-2 align-top text-gray-400", children: toCurrency }) : null
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "mt-3 text-xs text-gray-400 space-y-1", children: [
                isBuyingForeign && /* @__PURE__ */ jsxs(Fragment, { children: [
                  /* @__PURE__ */ jsxs("p", { children: [
                    "Cotação Comercial: R$ ",
                    rates[fromCurrency].toLocaleString("pt-BR", { minimumFractionDigits: 4 })
                  ] }),
                  /* @__PURE__ */ jsxs("p", { children: [
                    "+ IOF (",
                    iofType === "card" ? "3,38%" : "1,10%",
                    "): R$ ",
                    ((finalVetValue || 0) - (result || 0)).toLocaleString("pt-BR", { minimumFractionDigits: 2 })
                  ] })
                ] }),
                !isBuyingForeign && rates[fromCurrency] > 1 && /* @__PURE__ */ jsxs("p", { children: [
                  "1 ",
                  fromCurrency,
                  " = ",
                  rates[fromCurrency].toLocaleString("pt-BR", { minimumFractionDigits: 2 }),
                  " BRL"
                ] })
              ] })
            ] }) })
      ...
      /* @__PURE__ */ jsx("div", { className: "mt-8 max-w-3xl mx-auto text-lg text-gray-400 space-y-4 text-center mb-12", children: /* @__PURE__ */ jsxs("p", { children: [
        "Converta Dólar, Euro e Libra com a cotação oficial de agora. Descubra exatamente quanto sua compra vai custar no final, já incluindo o IOF atualizado de 2025 e as taxas bancárias. ",
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-[#1a1a1a]/50 backdrop-blur-xl border border-white/5 rounded-3xl p-5 md:p-8 mb-12 animate-in fade-in slide-in-from-bottom-4 duration-700", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4 mb-6", children: [
          /* @__PURE__ */ jsx("div", { className: "bg-emerald-500/10 p-3 rounded-xl shrink-0", children: /* @__PURE__ */ jsx(CreditCard, { className: "w-6 h-6 text-emerald-500" }) }),
          /* @__PURE__ */ jsx("h2", { className: "text-xl md:text-2xl font-bold text-white leading-tight mt-1", children: "Cronograma de Redução do IOF (Cartão de Crédito)" })
        ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-[#1a1a1a]/50 backdrop-blur-xl border border-white/5 rounded-3xl p-5 md:p-8 mb-12 animate-in fade-in slide-in-from-bottom-4 duration-700", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4 mb-6", children: [
          /* @__PURE__ */ jsx("div", { className: "bg-emerald-500/10 p-3 rounded-xl shrink-0", children: /* @__PURE__ */ jsx(Globe, { className: "w-6 h-6 text-emerald-500" }) }),
          /* @__PURE__ */ jsx("h2", { className: "text-xl md:text-2xl font-bold text-white leading-tight mt-1", children: "Poder de Compra: Quanto vale US$ 100 e € 100 hoje?" })
        ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-[#1a1a1a]/50 backdrop-blur-xl border border-white/5 rounded-3xl p-5 md:p-8 mb-12 animate-in fade-in slide-in-from-bottom-4 duration-700", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4 mb-6", children: [
          /* @__PURE__ */ jsx("div", { className: "bg-emerald-500/10 p-3 rounded-xl shrink-0", children: /* @__PURE__ */ jsx(Info, { className: "w-6 h-6 text-emerald-500" }) }),
          /* @__PURE__ */ jsx("h2", { className: "text-xl md:text-2xl font-bold text-white leading-tight mt-1", children: "Dicionário de Taxas: VET, Spread e PTAX" })
        ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 gap-6 md:gap-8 mb-12", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-[#1a1a1a]/50 backdrop-blur-xl border border-white/5 rounded-3xl p-5 md:p-8 animate-in fade-in slide-in-from-bottom-4 duration-700 min-w-0", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4 mb-5", children: [
            ...
            /* @__PURE__ */ jsx("h2", { className: "text-xl md:text-2xl font-bold text-white leading-tight mt-1", children: "Comercial vs. Turismo: Qual a diferença?" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "space-y-4 text-gray-400 leading-relaxed", children: [
            /* @__PURE__ */ jsxs("p", { className: "text-sm md:text-base", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "overflow-x-auto w-full max-w-full pb-2", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse text-sm min-w-[320px]", children: [
              /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "border-b border-white/10", children: [
                /* @__PURE__ */ jsx("th", { className: "p-3 text-white whitespace-nowrap", children: "Tipo" }),
                /* @__PURE__ */ jsx("th", { className: "p-3 text-white", children: "Onde é usado?" }),
                /* @__PURE__ */ jsx("th", { className: "p-3 text-white whitespace-nowrap", children: "Custo" })
              ] }) }),
              /* @__PURE__ */ jsxs("tbody", { className: "text-gray-400", children: [
                /* @__PURE__ */ jsxs("tr", { className: "border-b border-white/5", children: [
                  /* @__PURE__ */ jsx("td", { className: "p-3 font-bold text-white", children: "Comercial" }),
                  /* @__PURE__ */ jsx("td", { className: "p-3 text-xs md:text-sm", children: "Transações digitais e Global Accounts." }),
                  /* @__PURE__ */ jsx("td", { className: "p-3 font-bold text-emerald-400 text-xs md:text-sm whitespace-nowrap", children: "✅ Mais Barato" })
                ] }),
                /* @__PURE__ */ jsxs("tr", { children: [
                  /* @__PURE__ */ jsx("td", { className: "p-3 font-bold text-white", children: "Turismo" }),
                  /* @__PURE__ */ jsx("td", { className: "p-3 text-xs md:text-sm", children: "Dinheiro em espécie (papel)." }),
                  /* @__PURE__ */ jsx("td", { className: "p-3 font-bold text-red-400 text-xs md:text-sm whitespace-nowrap", children: "🔴 +6% a 8%" })
                ] })
              ] })
            ] }) }),
            /* @__PURE__ */ jsxs("p", { className: "text-xs italic mt-2 text-gray-400", children: [
              "*Nota: Se importa produtos, use a calculadora de ",
              /* @__PURE__ */ jsx(Link, { to: "/calculadoras/markup", className: "text-emerald-500 hover:text-emerald-300 underline decoration-emerald-400/30", children: "Markup" }),
              "."
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-[#1a1a1a]/50 backdrop-blur-xl border border-white/5 rounded-3xl p-5 md:p-8 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200 min-w-0", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4 mb-5", children: [
            /* @__PURE__ */ jsx("div", { className: "bg-emerald-500/10 p-3 rounded-xl shrink-0", children: /* @__PURE__ */ jsx(Calculator, { className: "w-6 h-6 text-emerald-500" }) }),
            /* @__PURE__ */ jsx("h2", { className: "text-xl md:text-2xl font-bold text-white leading-tight mt-1", children: "Simulação: Qual a melhor forma?" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "space-y-4 text-gray-400 leading-relaxed", children: [
            /* @__PURE__ */ jsxs("p", { className: "text-sm md:text-base", children: [
              "Comparativo para ",
            ...
            /* @__PURE__ */ jsx("div", { className: "overflow-x-auto w-full max-w-full pb-2", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse text-sm min-w-[340px]", children: [
              /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "border-b border-white/10", children: [
                /* @__PURE__ */ jsx("th", { className: "p-2 text-white whitespace-nowrap", children: "Modalidade" }),
                /* @__PURE__ */ jsx("th", { className: "p-2 text-white text-center whitespace-nowrap", children: "IOF" }),
                /* @__PURE__ */ jsx("th", { className: "p-2 text-white text-center whitespace-nowrap", children: "Veredito" })
              ] }) }),
              /* @__PURE__ */ jsxs("tbody", { className: "text-gray-400", children: [
                /* @__PURE__ */ jsxs("tr", { className: "border-b border-white/5 bg-emerald-500/5", children: [
                  /* @__PURE__ */ jsx("td", { className: "p-2 font-bold text-white text-xs md:text-sm", children: "Conta Global" }),
                  /* @__PURE__ */ jsx("td", { className: "p-2 text-center text-xs md:text-sm", children: "1,10%" }),
                  /* @__PURE__ */ jsx("td", { className: "p-2 text-center font-bold text-emerald-400 text-xs md:text-sm whitespace-nowrap", children: "✅ Melhor" })
                ] }),
                /* @__PURE__ */ jsxs("tr", { className: "border-b border-white/5", children: [
                  /* @__PURE__ */ jsx("td", { className: "p-2 text-xs md:text-sm", children: "Papel Moeda" }),
                  /* @__PURE__ */ jsx("td", { className: "p-2 text-center text-xs md:text-sm", children: "1,10%" }),
                  /* @__PURE__ */ jsx("td", { className: "p-2 text-center text-yellow-400 text-xs md:text-sm whitespace-nowrap", children: "🟡 Emergência" })
                ] }),
                /* @__PURE__ */ jsxs("tr", { children: [
                  /* @__PURE__ */ jsx("td", { className: "p-2 text-xs md:text-sm", children: "Cartão de Crédito" }),
                  /* @__PURE__ */ jsx("td", { className: "p-2 text-center text-xs md:text-sm", children: "3,38%" }),
                  /* @__PURE__ */ jsx("td", { className: "p-2 text-center text-red-400 text-xs md:text-sm whitespace-nowrap", children: "🔴 Caro" })
                ] })
              ] })
            ] }) }),
            /* @__PURE__ */ jsxs("p", { className: "text-sm", children: [
              "Planejando férias? Use a ",
              /* @__PURE__ */ jsx(Link, { to: "/calculadoras/custo-viagem", className: "text-emerald-400 hover:text-emerald-300 underline decoration-emerald-400/30", children: "Calculadora de Viagem" }),
              "."
            ] })
          ] })
        ] })
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-[#1a1a1a]/50 backdrop-blur-xl border border-white/5 rounded-3xl p-5 md:p-8 mb-24 animate-in fade-in slide-in-from-bottom-4 duration-700", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4 mb-6", children: [
          /* @__PURE__ */ jsx("div", { className: "bg-emerald-500/10 p-3 rounded-xl shrink-0", children: /* @__PURE__ */ jsx(TrendingUp, { className: "w-6 h-6 text-emerald-500" }) }),
          /* @__PURE__ */ jsx("h2", { className: "text-xl md:text-2xl font-bold text-white leading-tight mt-1", children: "O que faz o Dólar subir ou descer?" })
        ] }),
        /* @__PURE__ */ jsxs("p", { className: "text-gray-400 mb-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-3 gap-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "bg-white/5 p-6 rounded-xl border border-white/5", children: [
            /* @__PURE__ */ jsxs("h3", { className: "text-lg font-bold text-white mb-3 flex items-center gap-2", children: [
              /* @__PURE__ */ jsx("span", { className: "bg-emerald-500/20 text-emerald-400 w-6 h-6 rounded-full flex items-center justify-center text-sm", children: "1" }),
              "Taxa Selic"
            ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-white/5 p-6 rounded-xl border border-white/5", children: [
            /* @__PURE__ */ jsxs("h3", { className: "text-lg font-bold text-white mb-3 flex items-center gap-2", children: [
              /* @__PURE__ */ jsx("span", { className: "bg-emerald-500/20 text-emerald-400 w-6 h-6 rounded-full flex items-center justify-center text-sm", children: "2" }),
              "Risco Fiscal"
            ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-white/5 p-6 rounded-xl border border-white/5", children: [
            /* @__PURE__ */ jsxs("h3", { className: "text-lg font-bold text-white mb-3 flex items-center gap-2", children: [
              /* @__PURE__ */ jsx("span", { className: "bg-emerald-500/20 text-emerald-400 w-6 h-6 rounded-full flex items-center justify-center text-sm", children: "3" }),
              "Juros nos EUA (Fed)"
            ] }),
  ...
  return /* @__PURE__ */ jsx("div", { ref, className: "h-full w-full flex flex-col relative min-h-[450px]", children: !shouldLoad ? /* @__PURE__ */ jsxs("div", { className: "w-full h-full bg-[#1a1a1a]/50 backdrop-blur-xl rounded-3xl border border-white/5 flex flex-col items-center justify-center p-6 text-center z-10 transition-all", children: [
    ...
    /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsx(RefreshCw, { className: "w-5 h-5 group-hover:rotate-180 transition-transform duration-500" }),
          "Carregar Gráfico"
        ]
      }
    )
...
//# sourceMappingURL=CurrencyConverterPage-CiPHpTr8.js.map
