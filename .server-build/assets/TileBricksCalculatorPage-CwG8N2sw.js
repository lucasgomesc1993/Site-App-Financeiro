...
function TileBricksCalculatorPage() {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "relative min-h-screen pt-32 pb-24 px-4 overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto relative z-10", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "mt-8 max-w-2xl mx-auto text-lg text-gray-400 text-center mb-12", children: /* @__PURE__ */ jsx("p", { children: "Evite sobras ou falta de material. Calcule a quantidade exata para sua reforma." }) }),
      /* @__PURE__ */ jsx(
        FAQ,
        {
          items: TILE_FAQS,
...
//# sourceMappingURL=TileBricksCalculatorPage-CwG8N2sw.js.map
