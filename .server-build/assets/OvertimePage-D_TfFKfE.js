      ...
      /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-12 gap-8 mb-16", children: [
        /* @__PURE__ */ jsx("div", { className: "lg:col-span-7 animate-in fade-in slide-in-from-left-4 duration-700 delay-200", children: /* @__PURE__ */ jsxs("div", { className: "bg-[#1a1a1a]/50 backdrop-blur-xl border border-white/5 rounded-3xl p-6 md:p-8 h-full", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
            /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 gap-6", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsx("label", { htmlFor: "hours-select", className: "text-sm text-gray-400", children: "Jornada Mensal" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 gap-6", children: [
              /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: "absolute right-4 top-1/2 -translate-y-1/2 text-xs text-gray-400", children: "Dias Úteis" })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: "absolute right-4 top-1/2 -translate-y-1/2 text-xs text-gray-400", children: "Domingos/Feriados" })
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 gap-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "lg:col-span-5 space-y-8 animate-in fade-in slide-in-from-right-4 duration-700 delay-400", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-[#1a1a1a]/50 backdrop-blur-xl border border-white/5 rounded-3xl p-6", children: [
            ...
            /* @__PURE__ */ jsxs("p", { className: "text-xs text-gray-400 mt-4 italic", children: [
              "* Se você faz muitas horas extras, compare se ",
              /* @__PURE__ */ jsx(Link, { to: "/calculadoras/clt-vs-pj", className: "text-blue-400 underline", children: "vale a pena virar PJ" }),
              "."
            ] })
          ] })
        ] })
      ...
      /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto space-y-12 mb-24 animate-in fade-in slide-in-from-bottom-4 duration-700", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-4 text-gray-400 leading-relaxed", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 gap-4 mt-6", children: [
              /* @__PURE__ */ jsxs("div", { className: "bg-white/5 p-4 rounded-xl space-y-2", children: [
                /* @__PURE__ */ jsx("span", { className: "text-xs text-gray-400 uppercase tracking-wider font-semibold", children: "Passo 1: Hora Normal" }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "bg-white/5 p-4 rounded-xl space-y-2", children: [
                /* @__PURE__ */ jsx("span", { className: "text-xs text-gray-400 uppercase tracking-wider font-semibold", children: "Passo 2: Hora Extra (50%)" }),
                /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-sm", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "bg-white/5 p-4 rounded-xl space-y-2", children: [
                /* @__PURE__ */ jsx("span", { className: "text-xs text-gray-400 uppercase tracking-wider font-semibold", children: "Passo 3: Total (10h)" }),
                /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-sm", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "bg-white/5 p-4 rounded-xl space-y-2", children: [
                /* @__PURE__ */ jsx("span", { className: "text-xs text-gray-400 uppercase tracking-wider font-semibold", children: "Passo 4: DSR (25 úteis / 5 dom)" }),
                /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-sm", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 gap-8", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-[#1a1a1a]/50 backdrop-blur-xl border border-white/5 rounded-3xl p-8", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-400 mt-4 leading-relaxed", children: "* Convenções Coletivas podem estipular porcentagens maiores (ex: 60%, 70% ou 100% aos sábados)." })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsx(
...
//# sourceMappingURL=OvertimePage-D_TfFKfE.js.map
