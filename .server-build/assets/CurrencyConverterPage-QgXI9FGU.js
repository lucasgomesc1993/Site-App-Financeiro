...
const CurrencyChart = lazy(() => import("./CurrencyChart-CVdvqHFS.js"));
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-12 gap-8 mb-16", children: [
        ...
        /* @__PURE__ */ jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsx(Suspense, { fallback: /* @__PURE__ */ jsx("div", { className: "h-full w-full bg-[#1a1a1a]/50 backdrop-blur-xl border border-white/5 rounded-3xl p-6 md:p-8 flex items-center justify-center", children: /* @__PURE__ */ jsx(RefreshCw, { className: "w-8 h-8 text-emerald-500 animate-spin" }) }), children: /* @__PURE__ */ jsx(CurrencyChart, {}) })
          }
        )
      ] }),
...
//# sourceMappingURL=CurrencyConverterPage-QgXI9FGU.js.map
