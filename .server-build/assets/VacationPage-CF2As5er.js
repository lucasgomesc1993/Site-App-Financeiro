    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto relative z-10", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-16 max-w-4xl mx-auto pb-20", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-[#1a1a1a]/50 backdrop-blur-xl border border-white/5 rounded-3xl p-5 md:p-8 mb-12", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-gray-400 leading-relaxed mb-4", children: "Esta ferramenta aplica rigorosamente a legislação trabalhista vigente em **dezembro de 2025**. Diferente de simuladores genéricos, nosso algoritmo considera a tributação progressiva do INSS (cobrada faixa a faixa), a nova tabela de IRRF e as regras de isenção para quem vende dias." }),
          /* @__PURE__ */ jsx("p", { className: "text-gray-400 leading-relaxed", children: "**Como usar a calculadora:** Insira seu salário bruto atual, informe o número de dependentes (para dedução do IR) e selecione quantos dias de férias pretende gozar (ex: 20 ou 30 dias). A **Calculadora de Férias 2025** fará o cruzamento imediato com as tabelas oficiais para exibir seu valor líquido." })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold text-white", children: "Tabelas Oficiais para o Cálculo (2025)" }),
            /* @__PURE__ */ jsx("p", { className: "text-gray-400", children: "Para garantir a precisão da **Calculadora de Férias 2025**, o cálculo segue rigorosamente a **Tabela Progressiva do INSS** (atualizada pelo INPC de 2024) e a **Tabela de Imposto de Renda** (Lei nº 15.191)." })
          ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-[#1a1a1a]/50 border border-white/5 rounded-2xl overflow-hidden", children: [
            /* @__PURE__ */ jsxs("div", { className: "p-4 bg-white/5 border-b border-white/5", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-400 mt-1", children: "O sistema verifica automaticamente se o **Desconto Simplificado (R$ 607,20)** é mais vantajoso que as deduções legais." })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left text-sm", children: [
              /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "border-b border-white/5 text-gray-400", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-gray-400", children: 'Muitos trabalhadores perdem dinheiro ou se confundem ao tentar fazer a conta "na ponta do lápis" sem considerar as nuances da legislação atual. Ao utilizar uma **Calculadora de Férias 2025** atualizada, você evita os seguintes equívocos:' }),
          /* @__PURE__ */ jsxs("ul", { className: "space-y-3 text-gray-400 list-disc pl-5", children: [
            ...
            /* @__PURE__ */ jsxs("li", { children: [
              ...
              " Se você optar por converter 1/3 das férias em dinheiro, **não incide INSS nem IRRF** sobre esse valor específico. Calculadoras desatualizadas aplicam impostos aqui, subestimando o valor que você tem a receber."
            ] }),
            /* @__PURE__ */ jsxs("li", { children: [
              /* @__PURE__ */ jsx("strong", { children: "Média Financeira x Média Física:" }),
              " Para horas extras, não se faz a média dos valores recebidos. Faz-se a média da **quantidade de horas** nos últimos 12 meses e multiplica-se pelo valor da hora atual. Isso protege seu poder de compra contra a inflação. Você pode verificar suas médias usando nossa ",
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-[#1a1a1a]/50 border border-white/5 rounded-2xl p-6", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-gray-400 mb-4", children: "Vamos supor que um trabalhador ganhe R$ 3.000,00, sem dependentes, e vai tirar 30 dias de férias em dezembro de 2025. Se você fizer essa simulação na **Calculadora de Férias 2025**, verá o seguinte detalhamento:" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-[#1a1a1a]/50 border border-white/5 rounded-2xl p-6", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-gray-400 mb-4", children: "Ao simular um alto rendimento na **Calculadora de Férias 2025**, vemos o efeito do Teto do INSS e a alíquota máxima do Imposto de Renda." }),
            /* @__PURE__ */ jsxs("ol", { className: "list-decimal pl-5 space-y-3 text-gray-300", children: [
              /* @__PURE__ */ jsxs("li", { children: [
                /* @__PURE__ */ jsx("strong", { children: "Cálculo do Bruto:" }),
                /* @__PURE__ */ jsxs("ul", { className: "list-disc pl-5 mt-1 text-gray-400", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-gray-400", children: "O cálculo final na **Calculadora de Férias 2025** depende diretamente do seu histórico de presença, pois o Artigo 130 da CLT estabelece um sistema de proporcionalidade. Faltas sem justificativa legal (atestado, casamento, luto) durante o período aquisitivo reduzem os dias de descanso a que você tem direito." }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxs("p", { className: "text-gray-400", children: [
                "Uma atualização importante trazida pela **Instrução Normativa nº 213/2025** exige que terceirizados com dedicação exclusiva na Administração Pública Federal planejem suas férias com 60 dias de antecedência. Consulte a norma completa no ",
...
//# sourceMappingURL=VacationPage-CF2As5er.js.map
