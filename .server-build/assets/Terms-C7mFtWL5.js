      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-[#1a1a1a]/50 backdrop-blur-xl border border-white/5 rounded-3xl p-8 md:p-12 shadow-2xl", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-12", children: [
          ...
          /* @__PURE__ */ jsxs("section", { children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-gray-400 leading-relaxed pl-11 mb-4", children: "A Junny é uma ferramenta de gestão financeira baseada em inteligência artificial que opera através do WhatsApp. O serviço permite que os usuários:" }),
          ...
          /* @__PURE__ */ jsxs("section", { children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-gray-400 leading-relaxed pl-11", children: "A Junny oferece planos gratuitos e pagos. Os detalhes dos preços e recursos estão disponíveis em nossa página principal. Reservamo-nos o direito de alterar os preços a qualquer momento, com aviso prévio aos usuários ativos. O cancelamento pode ser feito a qualquer momento sem multa." })
          ] })
        ] })
      ] })
    ] })
...
//# sourceMappingURL=Terms-C7mFtWL5.js.map
