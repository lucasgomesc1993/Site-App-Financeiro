...
import { ShieldCheck, Share2, MessageCircle, Linkedin, Facebook, Twitter, Check, Link as Link$1, ChevronUp, ChevronDown } from "lucide-react";
import { u as useCalculatorContext } from "./CalculatorContext-CjI84puU.js";
import { Link } from "react-router-dom";
import { A as AUTHOR } from "./author-BdzMjBtJ.js";
    ...
    Link,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "text-xs text-gray-400 line-clamp-1 max-w-[200px] md:max-w-none", children: AUTHOR.role })
        ] })
      ]
    }
  ) });
...
const ShareButtons = ({ className = "" }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: `flex flex-col items-center gap-4 ${className}`, children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsx("div", { className: "h-[1px] w-12 bg-gradient-to-r from-transparent to-white/20" }),
      /* @__PURE__ */ jsxs("span", { className: "text-sm font-medium text-gray-400 flex items-center gap-2", children: [
        /* @__PURE__ */ jsx(Share2, { className: "w-4 h-4" }),
        "Compartilhar"
      ] }),
      /* @__PURE__ */ jsx("div", { className: "h-[1px] w-12 bg-gradient-to-l from-transparent to-white/20" })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
      shareLinks.map((link, idx) => /* @__PURE__ */ jsx(
        "a",
        {
          href: link.href,
          target: "_blank",
      ...
      /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          title: "Copiar Link",
          children: [
            copied ? /* @__PURE__ */ jsx(Check, { className: "w-5 h-5 text-green-500" }) : /* @__PURE__ */ jsx(Link$1, { className: "w-5 h-5" }),
            copied && /* @__PURE__ */ jsx("span", { className: "absolute -top-10 left-1/2 -translate-x-1/2 px-2 py-1 bg-black text-white text-xs rounded shadow-lg whitespace-nowrap animate-in fade-in slide-in-from-bottom-1", children: "Linkcopiado!" })
          ]
        }
      )
    ] })
...
const FAQ = ({ items, title = "Dúvidas frequentes", className = "py-24 md:py-32", showSocialProof = true }) => {
  ...
  return /* @__PURE__ */ jsx("section", { id: "faq", className: `px-4 ${className} ${isCalculator ? "-mt-6 !pt-0 bg-transparent" : "bg-background"}`, children: /* @__PURE__ */ jsxs("div", { className: `${isCalculator ? "max-w-7xl" : "max-w-3xl"} mx-auto`, children: [
    ...
    isCalculator && /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx(ShareButtons, { className: "mt-12 md:mt-16" }),
      /* @__PURE__ */ jsx(AuthorBadge, { className: "mt-12" })
    ] })
  ] }) });
};
export {
...
//# sourceMappingURL=FAQ-DBChmTgn.js.map
