...
const Home = lazy(() => import("./assets/Home-B5YAd02V.js").then((module) => ({ default: module.Home })));
...
const Calculators = lazy(() => import("./assets/Calculators-Cs3ZhiJ-.js").then((module) => ({ default: module.Calculators })));
const InvestmentPage = lazy(() => import("./assets/InvestmentPage-CVG4itHk.js").then((module) => ({ default: module.InvestmentPage })));
const VacationPage = lazy(() => import("./assets/VacationPage-Dx3-SrnN.js").then((module) => ({ default: module.VacationPage })));
const EnergyPage = lazy(() => import("./assets/EnergyPage-BzqSEA1b.js").then((module) => ({ default: module.EnergyPage })));
const FuelPage = lazy(() => import("./assets/FuelPage-CqJgBK6G.js").then((module) => ({ default: module.FuelPage })));
const TerminationPage = lazy(() => import("./assets/TerminationPage-BTdCXnqO.js").then((module) => ({ default: module.TerminationPage })));
const INSSPage = lazy(() => import("./assets/INSSPage-BzfEiidf.js").then((module) => ({ default: module.INSSPage })));
const NetSalaryPage = lazy(() => import("./assets/NetSalaryPage-BtADOU5A.js").then((module) => ({ default: module.NetSalaryPage })));
const ThirteenthSalaryPage = lazy(() => import("./assets/ThirteenthSalaryPage-CmcN7J4J.js").then((module) => ({ default: module.ThirteenthSalaryPage })));
const OvertimePage = lazy(() => import("./assets/OvertimePage-Ctk7LZIY.js").then((module) => ({ default: module.OvertimePage })));
const UnemploymentInsurancePage = lazy(() => import("./assets/UnemploymentInsurancePage-Bb9eTPZp.js").then((module) => ({ default: module.UnemploymentInsurancePage })));
const NightShiftPage = lazy(() => import("./assets/NightShiftPage-ClZQSKHe.js").then((module) => ({ default: module.NightShiftPage })));
const FGTSPage = lazy(() => import("./assets/FGTSPage-Dybq-C3Q.js").then((module) => ({ default: module.FGTSPage })));
const EmployeeCostPage = lazy(() => import("./assets/EmployeeCostPage-FqeLPVIt.js").then((module) => ({ default: module.EmployeeCostPage })));
const PLRPage = lazy(() => import("./assets/PLRPage-BkGdOGUS.js").then((module) => ({ default: module.PLRPage })));
const FIREPage = lazy(() => import("./assets/FIREPage-Dd7VZaRX.js").then((module) => ({ default: module.FIREPage })));
const CompoundInterestPage = lazy(() => import("./assets/CompoundInterestPage-C-QtBf6u.js").then((module) => ({ default: module.CompoundInterestPage })));
const RentVsBuyPage = lazy(() => import("./assets/RentVsBuyPage-keTwIKnw.js").then((module) => ({ default: module.RentVsBuyPage })));
const UberVsCarPage = lazy(() => import("./assets/UberVsCarPage-DImEqY-k.js").then((module) => ({ default: module.UberVsCarPage })));
const FirstMillionPage = lazy(() => import("./assets/FirstMillionPage-zdY364Ww.js").then((module) => ({ default: module.FirstMillionPage })));
const CurrencyConverterPage = lazy(() => import("./assets/CurrencyConverterPage-BCXkR3M2.js").then((module) => ({ default: module.CurrencyConverterPage })));
const PurchasingPowerPage = lazy(() => import("./assets/PurchasingPowerPage-wmWYTuY8.js").then((module) => ({ default: module.PurchasingPowerPage })));
const Budget503020Page = lazy(() => import("./assets/Budget503020Page-CzKYSeBz.js").then((module) => ({ default: module.Budget503020Page })));
const VehicleFinancingPage = lazy(() => import("./assets/VehicleFinancingPage-DcSuoxVu.js").then((module) => ({ default: module.VehicleFinancingPage })));
const RealEstateFinancingPage = lazy(() => import("./assets/RealEstateFinancingPage-Cijy8h46.js").then((module) => ({ default: module.RealEstateFinancingPage })));
const EarlyRepaymentPage = lazy(() => import("./assets/EarlyRepaymentPage-d--HdgEc.js").then((module) => ({ default: module.EarlyRepaymentPage })));
const CETCalculatorPage = lazy(() => import("./assets/CETCalculatorPage-C7g7Fncg.js").then((module) => ({ default: module.CETCalculatorPage })));
const CreditCardDebtPage = lazy(() => import("./assets/CreditCardDebtPage-CFFn6sdz.js").then((module) => ({ default: module.CreditCardDebtPage })));
const MEIDasPage = lazy(() => import("./assets/MEIDasPage-eJyPjQCp.js").then((module) => ({ default: module.MEIDasPage })));
const MarkupPage = lazy(() => import("./assets/MarkupPage-FBPrqRgV.js").then((module) => ({ default: module.MarkupPage })));
const BreakEvenPage = lazy(() => import("./assets/BreakEvenPage-Bso12yLR.js").then((module) => ({ default: module.BreakEvenPage })));
const SimplesVsPresumidoPage = lazy(() => import("./assets/SimplesVsPresumidoPage-DinRmHwh.js").then((module) => ({ default: module.SimplesVsPresumidoPage })));
const WorkingCapitalPage = lazy(() => import("./assets/WorkingCapitalPage-BYIt6TRF.js").then((module) => ({ default: module.WorkingCapitalPage })));
const ROICalculatorPage = lazy(() => import("./assets/ROICalculatorPage-BAy_Keyw.js").then((module) => ({ default: module.ROICalculatorPage })));
const BarbecueCalculatorPage = lazy(() => import("./assets/BarbecueCalculatorPage-KJx-1d4C.js").then((module) => ({ default: module.BarbecueCalculatorPage })));
const BusinessDaysPage = lazy(() => import("./assets/BusinessDaysPage-CbmzqIXz.js").then((module) => ({ default: module.BusinessDaysPage })));
const RuleOfThreePage = lazy(() => import("./assets/RuleOfThreePage-COsoXhHi.js").then((module) => ({ default: module.RuleOfThreePage })));
const PercentageCalculatorPage = lazy(() => import("./assets/PercentageCalculatorPage-BSp8ofRL.js").then((module) => ({ default: module.PercentageCalculatorPage })));
const HoursCalculatorPage = lazy(() => import("./assets/HoursCalculatorPage-DS0Q4sMN.js").then((module) => ({ default: module.HoursCalculatorPage })));
const TileBricksCalculatorPage = lazy(() => import("./assets/TileBricksCalculatorPage-BiV_mNPf.js").then((module) => ({ default: module.TileBricksCalculatorPage })));
const TravelCostCalculatorPage = lazy(() => import("./assets/TravelCostCalculatorPage-CbAMPzoZ.js").then((module) => ({ default: module.TravelCostCalculatorPage })));
const IMCCalculatorPage = lazy(() => import("./assets/IMCCalculatorPage-C_iDswiT.js").then((module) => ({ default: module.IMCCalculatorPage })));
const WaterIntakeCalculatorPage = lazy(() => import("./assets/WaterIntakeCalculatorPage-BoUj_sER.js").then((module) => ({ default: module.WaterIntakeCalculatorPage })));
const CulinaryConverterPage = lazy(() => import("./assets/CulinaryConverterPage-BUP723x1.js").then((module) => ({ default: module.CulinaryConverterPage })));
const GestationalAgeCalculatorPage = lazy(() => import("./assets/GestationalAgeCalculatorPage-TxJCm532.js").then((module) => ({ default: module.GestationalAgeCalculatorPage })));
const SecretSantaPage = lazy(() => import("./assets/SecretSantaPage-CFdwZ1Iw.js").then((module) => ({ default: module.SecretSantaPage })));
const PixGeneratorPage = lazy(() => import("./assets/PixGeneratorPage-CNKn_r2C.js").then((module) => ({ default: module.PixGeneratorPage })));
...
const BlogIndex = lazy(() => import("./assets/BlogIndex-7YFMslhr.js").then((module) => ({ default: module.BlogIndex })));
const CategoryPage = lazy(() => import("./assets/CategoryPage-BMev--H0.js").then((module) => ({ default: module.CategoryPage })));
const BlogPost = lazy(() => import("./assets/BlogPost-Brm_8jJY.js").then((module) => ({ default: module.BlogPost })));
