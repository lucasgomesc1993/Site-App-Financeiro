...
const Home = lazy(() => import("./assets/Home-V90ce_45.js").then((module) => ({ default: module.Home })));
...
const INSSPage = lazy(() => import("./assets/INSSPage-C1J4rDJy.js").then((module) => ({ default: module.INSSPage })));
const NetSalaryPage = lazy(() => import("./assets/NetSalaryPage-glXlLvwu.js").then((module) => ({ default: module.NetSalaryPage })));
const ThirteenthSalaryPage = lazy(() => import("./assets/ThirteenthSalaryPage-CjNh86Yq.js").then((module) => ({ default: module.ThirteenthSalaryPage })));
const OvertimePage = lazy(() => import("./assets/OvertimePage-CPcqDYpA.js").then((module) => ({ default: module.OvertimePage })));
const UnemploymentInsurancePage = lazy(() => import("./assets/UnemploymentInsurancePage-pzEoQfoV.js").then((module) => ({ default: module.UnemploymentInsurancePage })));
const NightShiftPage = lazy(() => import("./assets/NightShiftPage-Cn1vJRmh.js").then((module) => ({ default: module.NightShiftPage })));
const FGTSPage = lazy(() => import("./assets/FGTSPage-Bfs1Kbv_.js").then((module) => ({ default: module.FGTSPage })));
const EmployeeCostPage = lazy(() => import("./assets/EmployeeCostPage-wjmYXWuB.js").then((module) => ({ default: module.EmployeeCostPage })));
const PLRPage = lazy(() => import("./assets/PLRPage-B3RsKDU3.js").then((module) => ({ default: module.PLRPage })));
const FIREPage = lazy(() => import("./assets/FIREPage-DVxAHo3S.js").then((module) => ({ default: module.FIREPage })));
const CompoundInterestPage = lazy(() => import("./assets/CompoundInterestPage-CqCKIkOC.js").then((module) => ({ default: module.CompoundInterestPage })));
const RentVsBuyPage = lazy(() => import("./assets/RentVsBuyPage-DGN9-hvV.js").then((module) => ({ default: module.RentVsBuyPage })));
const UberVsCarPage = lazy(() => import("./assets/UberVsCarPage-sZD0j4kG.js").then((module) => ({ default: module.UberVsCarPage })));
const FirstMillionPage = lazy(() => import("./assets/FirstMillionPage-DS8gnaZe.js").then((module) => ({ default: module.FirstMillionPage })));
const CurrencyConverterPage = lazy(() => import("./assets/CurrencyConverterPage-CPHdtepm.js").then((module) => ({ default: module.CurrencyConverterPage })));
const PurchasingPowerPage = lazy(() => import("./assets/PurchasingPowerPage-43--HU5N.js").then((module) => ({ default: module.PurchasingPowerPage })));
const Budget503020Page = lazy(() => import("./assets/Budget503020Page-DLkpCiCs.js").then((module) => ({ default: module.Budget503020Page })));
const VehicleFinancingPage = lazy(() => import("./assets/VehicleFinancingPage--zV3SVLp.js").then((module) => ({ default: module.VehicleFinancingPage })));
const RealEstateFinancingPage = lazy(() => import("./assets/RealEstateFinancingPage-QbBRT4rU.js").then((module) => ({ default: module.RealEstateFinancingPage })));
const EarlyRepaymentPage = lazy(() => import("./assets/EarlyRepaymentPage-5cg6ok2m.js").then((module) => ({ default: module.EarlyRepaymentPage })));
const CETCalculatorPage = lazy(() => import("./assets/CETCalculatorPage-CpO5n5zD.js").then((module) => ({ default: module.CETCalculatorPage })));
const CreditCardDebtPage = lazy(() => import("./assets/CreditCardDebtPage-BAxjHQCN.js").then((module) => ({ default: module.CreditCardDebtPage })));
const MEIDasPage = lazy(() => import("./assets/MEIDasPage-x55_pSje.js").then((module) => ({ default: module.MEIDasPage })));
const MarkupPage = lazy(() => import("./assets/MarkupPage-CoHhEK9s.js").then((module) => ({ default: module.MarkupPage })));
const BreakEvenPage = lazy(() => import("./assets/BreakEvenPage-D7kma5Q3.js").then((module) => ({ default: module.BreakEvenPage })));
const SimplesVsPresumidoPage = lazy(() => import("./assets/SimplesVsPresumidoPage-DeRkgHDX.js").then((module) => ({ default: module.SimplesVsPresumidoPage })));
const WorkingCapitalPage = lazy(() => import("./assets/WorkingCapitalPage-Do3goJWk.js").then((module) => ({ default: module.WorkingCapitalPage })));
const ROICalculatorPage = lazy(() => import("./assets/ROICalculatorPage-PgYNnefl.js").then((module) => ({ default: module.ROICalculatorPage })));
const BarbecueCalculatorPage = lazy(() => import("./assets/BarbecueCalculatorPage-DcOkxtmz.js").then((module) => ({ default: module.BarbecueCalculatorPage })));
const BusinessDaysPage = lazy(() => import("./assets/BusinessDaysPage-9NVipFtX.js").then((module) => ({ default: module.BusinessDaysPage })));
const RuleOfThreePage = lazy(() => import("./assets/RuleOfThreePage-BMC6KWRM.js").then((module) => ({ default: module.RuleOfThreePage })));
const PercentageCalculatorPage = lazy(() => import("./assets/PercentageCalculatorPage-kAVR73eZ.js").then((module) => ({ default: module.PercentageCalculatorPage })));
...
const PixGeneratorPage = lazy(() => import("./assets/PixGeneratorPage-DU9_vDS0.js").then((module) => ({ default: module.PixGeneratorPage })));
...
const BlogPost = lazy(() => import("./assets/BlogPost-Di1azvD7.js").then((module) => ({ default: module.BlogPost })));
const AuthorPage = lazy(() => import("./assets/AuthorPage-Br6hZN2w.js").then((module) => ({ default: module.AuthorPage })));
