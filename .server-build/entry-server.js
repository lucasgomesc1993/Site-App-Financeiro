...
const Calculators = lazy(() => import("./assets/Calculators-CZK9I3-_.js").then((module) => ({ default: module.Calculators })));
const InvestmentPage = lazy(() => import("./assets/InvestmentPage-nLp19M5t.js").then((module) => ({ default: module.InvestmentPage })));
const VacationPage = lazy(() => import("./assets/VacationPage-Dx3-SrnN.js").then((module) => ({ default: module.VacationPage })));
const EnergyPage = lazy(() => import("./assets/EnergyPage-JUi1wX-5.js").then((module) => ({ default: module.EnergyPage })));
const FuelPage = lazy(() => import("./assets/FuelPage-KPed_Ata.js").then((module) => ({ default: module.FuelPage })));
const TerminationPage = lazy(() => import("./assets/TerminationPage-BtKWlzy0.js").then((module) => ({ default: module.TerminationPage })));
const INSSPage = lazy(() => import("./assets/INSSPage-B0vTc_qI.js").then((module) => ({ default: module.INSSPage })));
const NetSalaryPage = lazy(() => import("./assets/NetSalaryPage-G64iTTuL.js").then((module) => ({ default: module.NetSalaryPage })));
const ThirteenthSalaryPage = lazy(() => import("./assets/ThirteenthSalaryPage-CXKuR6hk.js").then((module) => ({ default: module.ThirteenthSalaryPage })));
const OvertimePage = lazy(() => import("./assets/OvertimePage-DKtYMmO3.js").then((module) => ({ default: module.OvertimePage })));
const UnemploymentInsurancePage = lazy(() => import("./assets/UnemploymentInsurancePage-BnP-Kpty.js").then((module) => ({ default: module.UnemploymentInsurancePage })));
const NightShiftPage = lazy(() => import("./assets/NightShiftPage-CuqR4-Uq.js").then((module) => ({ default: module.NightShiftPage })));
const FGTSPage = lazy(() => import("./assets/FGTSPage-BDXXfrO-.js").then((module) => ({ default: module.FGTSPage })));
const EmployeeCostPage = lazy(() => import("./assets/EmployeeCostPage-DAuh8FG8.js").then((module) => ({ default: module.EmployeeCostPage })));
const PLRPage = lazy(() => import("./assets/PLRPage-D6KRX0g7.js").then((module) => ({ default: module.PLRPage })));
const FIREPage = lazy(() => import("./assets/FIREPage-BH9DIYrg.js").then((module) => ({ default: module.FIREPage })));
const CompoundInterestPage = lazy(() => import("./assets/CompoundInterestPage-B-KfUCAg.js").then((module) => ({ default: module.CompoundInterestPage })));
const RentVsBuyPage = lazy(() => import("./assets/RentVsBuyPage-Dnetkzx_.js").then((module) => ({ default: module.RentVsBuyPage })));
const UberVsCarPage = lazy(() => import("./assets/UberVsCarPage-CNh6HMpm.js").then((module) => ({ default: module.UberVsCarPage })));
const FirstMillionPage = lazy(() => import("./assets/FirstMillionPage-Ca2pi5os.js").then((module) => ({ default: module.FirstMillionPage })));
const CurrencyConverterPage = lazy(() => import("./assets/CurrencyConverterPage-BsqNWM-u.js").then((module) => ({ default: module.CurrencyConverterPage })));
const PurchasingPowerPage = lazy(() => import("./assets/PurchasingPowerPage-DfupHtvG.js").then((module) => ({ default: module.PurchasingPowerPage })));
const Budget503020Page = lazy(() => import("./assets/Budget503020Page-C9NUl37F.js").then((module) => ({ default: module.Budget503020Page })));
const VehicleFinancingPage = lazy(() => import("./assets/VehicleFinancingPage-CgQx2UN2.js").then((module) => ({ default: module.VehicleFinancingPage })));
const RealEstateFinancingPage = lazy(() => import("./assets/RealEstateFinancingPage-DYixRk2_.js").then((module) => ({ default: module.RealEstateFinancingPage })));
const EarlyRepaymentPage = lazy(() => import("./assets/EarlyRepaymentPage-CIdFws_V.js").then((module) => ({ default: module.EarlyRepaymentPage })));
const CETCalculatorPage = lazy(() => import("./assets/CETCalculatorPage-x2qaVbkO.js").then((module) => ({ default: module.CETCalculatorPage })));
const CreditCardDebtPage = lazy(() => import("./assets/CreditCardDebtPage-CWwTZHP4.js").then((module) => ({ default: module.CreditCardDebtPage })));
const MEIDasPage = lazy(() => import("./assets/MEIDasPage-Bed9RGZx.js").then((module) => ({ default: module.MEIDasPage })));
const MarkupPage = lazy(() => import("./assets/MarkupPage-CQvOu3pp.js").then((module) => ({ default: module.MarkupPage })));
const BreakEvenPage = lazy(() => import("./assets/BreakEvenPage-CRU8MTfW.js").then((module) => ({ default: module.BreakEvenPage })));
const SimplesVsPresumidoPage = lazy(() => import("./assets/SimplesVsPresumidoPage-BZq75EZI.js").then((module) => ({ default: module.SimplesVsPresumidoPage })));
const WorkingCapitalPage = lazy(() => import("./assets/WorkingCapitalPage-t_tSny-B.js").then((module) => ({ default: module.WorkingCapitalPage })));
const ROICalculatorPage = lazy(() => import("./assets/ROICalculatorPage-DkOJBwCW.js").then((module) => ({ default: module.ROICalculatorPage })));
const BarbecueCalculatorPage = lazy(() => import("./assets/BarbecueCalculatorPage-C4IiYeoA.js").then((module) => ({ default: module.BarbecueCalculatorPage })));
const BusinessDaysPage = lazy(() => import("./assets/BusinessDaysPage-DOtiA6Ub.js").then((module) => ({ default: module.BusinessDaysPage })));
const RuleOfThreePage = lazy(() => import("./assets/RuleOfThreePage-izdArJfK.js").then((module) => ({ default: module.RuleOfThreePage })));
const PercentageCalculatorPage = lazy(() => import("./assets/PercentageCalculatorPage-Cep13uVF.js").then((module) => ({ default: module.PercentageCalculatorPage })));
const HoursCalculatorPage = lazy(() => import("./assets/HoursCalculatorPage-YwFQ8nc8.js").then((module) => ({ default: module.HoursCalculatorPage })));
const TileBricksCalculatorPage = lazy(() => import("./assets/TileBricksCalculatorPage-CwG8N2sw.js").then((module) => ({ default: module.TileBricksCalculatorPage })));
const TravelCostCalculatorPage = lazy(() => import("./assets/TravelCostCalculatorPage-CDsDi09u.js").then((module) => ({ default: module.TravelCostCalculatorPage })));
const IMCCalculatorPage = lazy(() => import("./assets/IMCCalculatorPage-DWIT9Cge.js").then((module) => ({ default: module.IMCCalculatorPage })));
const WaterIntakeCalculatorPage = lazy(() => import("./assets/WaterIntakeCalculatorPage-BCc7faqp.js").then((module) => ({ default: module.WaterIntakeCalculatorPage })));
const CulinaryConverterPage = lazy(() => import("./assets/CulinaryConverterPage-BxpX-PUS.js").then((module) => ({ default: module.CulinaryConverterPage })));
const GestationalAgeCalculatorPage = lazy(() => import("./assets/GestationalAgeCalculatorPage-CuZ9aOhU.js").then((module) => ({ default: module.GestationalAgeCalculatorPage })));
const SecretSantaPage = lazy(() => import("./assets/SecretSantaPage-DEBF73Gx.js").then((module) => ({ default: module.SecretSantaPage })));
const PixGeneratorPage = lazy(() => import("./assets/PixGeneratorPage-DHFDgKHT.js").then((module) => ({ default: module.PixGeneratorPage })));
...
const BlogPost = lazy(() => import("./assets/BlogPost-BLBdo5oc.js").then((module) => ({ default: module.BlogPost })));
