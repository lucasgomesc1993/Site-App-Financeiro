                ...
                <div className="space-y-16 max-w-4xl mx-auto pb-20">
                    ...
                    <div className="bg-[#1a1a1a]/50 backdrop-blur-xl border border-white/5 rounded-3xl p-5 md:p-8 mb-12">
                        ...
                        <p className="text-gray-400 leading-relaxed mb-4">
                            Esta ferramenta aplica rigorosamente a legislação trabalhista vigente em <strong>dezembro de 2025</strong>. Diferente de simuladores genéricos, nosso algoritmo considera a tributação progressiva do INSS (cobrada faixa a faixa), a nova tabela de IRRF e as regras de isenção para quem vende dias.
                        </p>
                        <p className="text-gray-400 leading-relaxed">
                            <strong>Como usar a calculadora:</strong> Insira seu salário bruto atual, informe o número de dependentes (para dedução do IR) e selecione quantos dias de férias pretende gozar (ex: 20 ou 30 dias). A <strong>Calculadora de Férias 2025</strong> fará o cruzamento imediato com as tabelas oficiais para exibir seu valor líquido.
                        </p>
                    </div>
                    ...
                    <div className="space-y-8">
                        <div className="space-y-4">
                            ...
                            <p className="text-gray-400">
                                Para garantir a precisão da <strong>Calculadora de Férias 2025</strong>, o cálculo segue rigorosamente a <strong>Tabela Progressiva do INSS</strong> (atualizada pelo INPC de 2024) e a <strong>Tabela de Imposto de Renda</strong> (Lei nº 15.191).
                            </p>
                        </div>
                        ...
                        <div className="bg-[#1a1a1a]/50 border border-white/5 rounded-2xl overflow-hidden">
                            <div className="p-4 bg-white/5 border-b border-white/5">
                                ...
                                <p className="text-xs text-gray-400 mt-1">O sistema verifica automaticamente se o <strong>Desconto Simplificado (R$ 607,20)</strong> é mais vantajoso que as deduções legais.</p>
                            </div>
                            <div className="overflow-x-auto">
                                <table className="w-full text-left text-sm">
                                    <thead>
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-400">
                            Muitos trabalhadores perdem dinheiro ou se confundem ao tentar fazer a conta "na ponta do lápis" sem considerar as nuances da legislação atual. Ao utilizar uma <strong>Calculadora de Férias 2025</strong> atualizada, você evita os seguintes equívocos:
                        </p>
                        <ul className="space-y-3 text-gray-400 list-disc pl-5">
                            ...
                            <li>
                                <strong>Tributar a venda de férias (Abono):</strong> Se você optar por converter 1/3 das férias em dinheiro, <strong>não incide INSS nem IRRF</strong> sobre esse valor específico. Calculadoras desatualizadas aplicam impostos aqui, subestimando o valor que você tem a receber.
                            </li>
                            <li>
                                <strong>Média Financeira x Média Física:</strong> Para horas extras, não se faz a média dos valores recebidos. Faz-se a média da <strong>quantidade de horas</strong> nos últimos 12 meses e multiplica-se pelo valor da hora atual. Isso protege seu poder de compra contra a inflação. Você pode verificar suas médias usando nossa <a href="https://junny.com.br/calculadoras/horas-extras" className="text-blue-400 hover:underline">calculadora de horas extras</a> antes de somar ao salário base.
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-[#1a1a1a]/50 border border-white/5 rounded-2xl p-6">
                            ...
                            <p className="text-gray-400 mb-4">
                                Vamos supor que um trabalhador ganhe R$ 3.000,00, sem dependentes, e vai tirar 30 dias de férias em dezembro de 2025. Se você fizer essa simulação na <strong>Calculadora de Férias 2025</strong>, verá o seguinte detalhamento:
                            </p>
                        ...
                        <div className="bg-[#1a1a1a]/50 border border-white/5 rounded-2xl p-6">
                            ...
                            <p className="text-gray-400 mb-4">
                                Ao simular um alto rendimento na <strong>Calculadora de Férias 2025</strong>, vemos o efeito do Teto do INSS e a alíquota máxima do Imposto de Renda.
                            </p>
                            <ol className="list-decimal pl-5 space-y-3 text-gray-300">
                                <li>
                                    <strong>Cálculo do Bruto:</strong>
                    ...
                    <div className="space-y-8">
                        ...
                        <p className="text-gray-400">Além do cálculo padrão, a <strong>Calculadora de Férias 2025</strong> contempla situações específicas que exigem atenção extra:</p>

                        <div className="space-y-6">
                            <div>
                                <h3 className="text-xl font-semibold text-white mb-2">Abono Pecuniário ("Venda de Férias")</h3>
                                <p className="text-gray-400">
                                    O trabalhador pode converter 1/3 do período de férias (geralmente 10 dias) em dinheiro. O prazo para solicitar isso é até 15 dias antes do término do período aquisitivo. A grande vantagem financeira é que, conforme legislação tributária, <strong>não há desconto de impostos</strong> sobre o valor da venda e o terço constitucional correspondente a ela.
                                </p>
                            </div>
